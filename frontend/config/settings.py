"""
Django settings for Grocery Billing System
"""
import os
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-grocery-billing-system-change-in-production')
...
INSTALLED_APPS = [
    # 'daphne',  # Temporarily disabled for SQLite setup
    ...
    # Local apps
    # 'apps.auth',  # Using django.contrib.auth instead
    'apps.dashboard',
    'apps.products',
    'apps.customers',
    'apps.billing',
...
#         'NAME': os.getenv('DB_NAME', 'grocery_billing_frontend'),
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'grocery-billing-cache',
    }
}

# Session Configuration
SESSION_ENGINE = 'django.contrib.sessions.backends.db'
# SESSION_CACHE_ALIAS = 'default'  # Not needed with db session backend
